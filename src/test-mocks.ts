 ...
 * });
 */
export function createMockCloudFrontService(
  overrides?: Partial<ICloudFrontService>
): ICloudFrontService {
  return {
 ...
 * });
 */
export function createMockRoute53Service(
  overrides?: Partial<IRoute53Service>
): IRoute53Service {
  return {
...
export function createMockDeploymentService(
  overrides?: Partial<IDeploymentService>
): IDeploymentService {
  return {
    deploy: async () => {
      // Mock deployment
