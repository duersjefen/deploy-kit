...
describe('SimpleCache', () => {
  ...
  beforeEach(() => {
    cache = new SimpleCache<string>(1000); // 1 second TTL for fast tests
  });
  ...
  describe('Basic Operations', () => {
    ...
    it('stores complex objects', () => {
      const complexCache = new SimpleCache<Record<string, unknown>>();
  ...
  describe('TTL and Expiration', () => {
    it('expires values after TTL', async () => {
      const shortCache = new SimpleCache<string>(100); // 100ms TTL
    ...
    it('uses custom TTL when provided to set()', async () => {
      const longCache = new SimpleCache<string>(100); // Default 100ms
  ...
  describe('Delete and Clear', () => {
    ...
    it('clears cache without affecting new instances', () => {
      ...
      const newCache = new SimpleCache<string>();
  ...
  describe('Type Safety', () => {
    it('works with different types', () => {
      ...
      const objectCache = new SimpleCache<{ id: string }>();
      const obj = { id: 'test' };
    ...
    it('maintains type through getOrSet', async () => {
      ...
      const fetcher = async (): Promise<User> => user;
  ...
  describe('Edge Cases', () => {
    it('handles null and undefined values', () => {
      const nullCache = new SimpleCache<string | null>();
