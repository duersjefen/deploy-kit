 ...
 * ```
 */
export function extractCloudFrontDistributionId(output: string): string | null {
 ...
 * ```
 */
export function isValidDistributionId(distributionId: string): boolean {
...
export function getAwsRegion(
  ...
  serviceType: 'cloudfront' | 'lambda' | 'default' = 'default'
): string {
 ...
 * ```
 */
export function extractInfrastructureDetails(output: string): {
