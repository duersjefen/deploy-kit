...
export class SstOutputHandler {
  ...
  private onCriticalError?: (error: CriticalError) => void;
  private errorBuffer: string[] = []; // Keep recent lines for context
   ...
   */
  private detectCriticalErrors(line: string): void {
   ...
   */
  private emitCriticalError(error: CriticalError): void {
