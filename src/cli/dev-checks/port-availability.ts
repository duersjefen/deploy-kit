 ...
 */
function checkPort(port: number): PortInfo {
  try {
 ...
 */
export function findAvailablePort(startPort: number = 3000, maxAttempts: number = 10): PortInfo | null {
 ...
 */
export function createPortAvailabilityCheck(requestedPort: number = 3000): () => Promise<CheckResult> {
  return async () => {
