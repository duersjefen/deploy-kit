 ...
 */
export function generateMaintenancePage(options = {}) {
    const { title = 'We\'re Updating!', message = 'We\'re deploying some updates to improve your experience. We\'ll be back in a moment.', estimatedDuration = 60, refreshInterval = 10, primaryColor = '#3b82f6', backgroundColor = '#ffffff', } = options;
    return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
