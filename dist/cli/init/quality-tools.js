 ...
 */
export function createLintStagedConfig(projectRoot) {
 ...
 */
export function createHuskyPreCommitHook(projectRoot) {
 ...
 */
export async function installQualityTools(projectRoot) {
 ...
 */
export function addPrepareScript(projectRoot) {
