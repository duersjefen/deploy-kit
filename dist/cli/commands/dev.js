 ...
 */
export async function handleDevCommand(projectRoot = process.cwd(), options = {}) {
    try {
 ...
 */
async function runPreFlightChecks(projectRoot, config) {
    const checks = [
 ...
 */
async function checkAwsCredentials(projectRoot, config) {
 ...
 * Check 2: SST Lock
 */
async function checkSstLock(projectRoot) {
 ...
 */
async function checkSstConfig(projectRoot) {
 ...
 */
async function checkSstStateHealth(projectRoot) {
 ...
 */
async function checkRecursiveSstDev(projectRoot) {
 ...
 */
async function checkNextJsCanaryFeatures(projectRoot) {
 ...
 */
async function checkPulumiOutputUsage(projectRoot) {
 ...
 */
async function startSstDev(projectRoot, config, options) {
 ...
 */
async function handleSstDevError(error) {
