 ...
 */
export async function setupRemoteDeploy(projectRoot = process.cwd()) {
 ...
 */
async function createDeployWorkflow(projectRoot) {
 ...
 */
async function detectAWSProfile(projectRoot) {
 ...
 */
async function addGitHubSecrets(projectRoot, awsProfile) {
 ...
 */
function outputManualSecrets(awsProfile) {
